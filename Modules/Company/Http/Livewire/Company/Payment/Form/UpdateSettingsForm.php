...
class UpdateSettingsForm extends Component
{
    ...
    protected $rules = [
        ...
        'payment.customer_name' => 'nullable|max:255',
        'payment.company_id' => 'nullable|integer',
        'payment.company_name' => 'nullable|max:255',
        'payment.monitoring_id' => 'nullable|integer',
        'payment.monitoring_name' => 'nullable|max:255',
        'payment.id' => 'nullable|integer',
        'payment.name' => 'nullable|max:255',
        ...
        'payment.payment_method' => 'nullable|max:255',
        'payment.bank_name' => 'nullable|max:255',
