...
class AdministratorPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Administrator $admin)
    {
        $isSuperAdmin = $user->coordinate->isSuperAdministrator();
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Administrator $admin)
    {
        $isSuperAdmin = $user->coordinate->isSuperAdministrator();
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Administrator $admin)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Administrator $admin)
    {
        return $user->coordinate->isSuperAdministrator()
            ? Response::allow()
            : Response::deny('You must be an super administrator.');
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Administrator $admin)
    {
        return $user->coordinate->isSuperAdministrator()
            ? Response::allow()
            : Response::deny('You must be an super administrator.');
